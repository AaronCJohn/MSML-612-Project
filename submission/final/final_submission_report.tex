...
The baseline for the final system is an \textbf{unconditional diffusion}
...
therefore a \textbf{conditional diffusion} model on a unified RGB dataset
...
signal, supports multi-style training in one network, and allows a
...
\begin{minipage}{0.48\linewidth}
\centering
\includegraphics[width=\linewidth,height=0.34\textheight,keepaspectratio]{\detokenize{images/slide 17/3d_samples_epoch_350.png}}
\caption*{3D}
\end{minipage}\hfill
\begin{minipage}{0.48\linewidth}
\centering
\includegraphics[width=\linewidth,height=0.34\textheight,keepaspectratio]{\detokenize{images/slide 17/sprite_samples_epoch_500.png}}
\caption*{Sprites}
\end{minipage}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\linewidth,height=0.42\textheight,keepaspectratio]{\detokenize{images/slide 18/grid.png}}
...
The GAN baseline remains useful as a qualitative reference for the
...
\tightlist
\item
  \textbf{Aaron Cyril John:} Led final report and slide integration,
  curated evaluation figures and metrics, reconciled preprocessing and
  training documentation, and supported model training and result
  analysis.
\item
  \textbf{Yugaank Kalia:} Contributed to dataset curation, mapping
  verification, preprocessing design, model experimentation, and
  presentation materials.
\item
  \textbf{Varen Maniktala:} Contributed to dataset alignment,
  architecture review, training/evaluation support, and final
